...
protocol NetworkManaging: AnyObject {
  func fetchRequest<T: Decodable>(type: T.Type,
                                  apiInformation: ApiInformation) async throws -> T
}
...
class NetworkManager: NetworkManaging {
  ...
  init(requestHandler: RequestHandler,
       sessionHandler: Session = CwSessionHandler.sessionManager,
       reachabilityManager: NetworkReachabilityManager? = NetworkReachabilityManager.default
  ) {
